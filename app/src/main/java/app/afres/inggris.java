...
public class inggris extends AppCompatActivity {
    ...
    public static String url = "http://192.168.173.1/kuis/binggris/soal.php";
    ...
    public class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(inggris.this);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(inggris.this,"Mengambil Skor...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(inggris.this,s,Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest(Server.URL_UPDATE_EMP_skor_BI,hashMap);
                return s;
    ...
    public View.OnClickListener klikSelesai = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(inggris.this)
                    .create();
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            updateEmployee();
            Toast.makeText(inggris.this, "Waktu Habis",
