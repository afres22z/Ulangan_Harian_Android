...
public class Ipa extends AppCompatActivity {
    ...
    public static String url = "http://192.168.173.1/kuis/ipa/soal.php";
    ...
    public class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Ipa.this);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Ipa.this,"Mengambil Skor...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(Ipa.this,s,Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest(Server.URL_UPDATE_EMP_skor_Ipa,hashMap);
                return s;
    ...
    public View.OnClickListener klikSelesai = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(Ipa.this)
                    .create();
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            updateEmployee();
            Toast.makeText(Ipa.this, "Waktu Habis",
