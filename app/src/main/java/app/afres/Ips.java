...
public class Ips extends AppCompatActivity {
    ...
    public static String url = "http://192.168.173.1/kuis/ips/soal.php";
    ...
    public class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Ips.this);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Ips.this,"Mengambil Skor...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(Ips.this,s,Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest(Server.URL_UPDATE_EMP_skor_Ips,hashMap);
                return s;
    ...
    public View.OnClickListener klikSelesai = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(Ips.this)
                    .create();
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            updateEmployee();
            Toast.makeText(Ips.this, "Waktu Habis",
