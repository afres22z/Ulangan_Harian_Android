...
public class Bahasa extends AppCompatActivity {
    ...
    public static String url = "http://192.168.173.1/kuis/bahasa/soal.php";
    ...
    public class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Bahasa.this);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Bahasa.this,"Mengambil Skor...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(Bahasa.this,s,Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest(Server.URL_UPDATE_EMP_skor_B,hashMap);
                return s;
    ...
    public void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            if (txtWaktu.getText().equals("00:00:00")){
                updateEmployee();
    ...
    public View.OnClickListener klikSelesai = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(Bahasa.this)
                    .create();
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            updateEmployee();
            Toast.makeText(Bahasa.this, "Waktu Habis",
